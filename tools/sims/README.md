...
| `construction-chat-check.mjs` | **20/20** | Full-screen staged builder, collapsed/editable trip facts, tab-safe conversation state, three measured options, verified stop pieces, refinement, confirmation, phone/desktop fit. |
