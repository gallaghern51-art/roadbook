...
| `construction-chat-check.mjs` | **22/22** | Full-screen staged builder, desktop conversation/plan split, phone view switch, collapsed trip facts, tab-safe state, measured/verified options, refinement and confirmation. |
