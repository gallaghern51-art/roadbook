...
-- ----------------------------------------- private place preference history ----
-- The evidence behind personalized restaurant/lodging/experience picks. Only
-- meaningful construction decisions are stored: option selected, place
-- rejected, or trip confirmed. Opening a details panel is deliberately noise,
-- not a preference event.
