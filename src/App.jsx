          ...
          onAddToTrip={({ tripId, dayId, place }) => {
            ...
            dispatch({
              ...
              ops: [{
                ...
                // a listing carries its identity; a dropped pin carries the rider's intent
                waypoint: { name: place.name, ...pt, kind: 'via', note: place.detail ?? '', ...(place.placeId ? { placeId: place.placeId, verified: 'google' } : place.placed ? { placed: place.placed } : {}) },
              }],
            });
