...
//   inline   false | true | 'desktop'
export default function PlaceSheet({ place, glyph = '📍', kicker = '', note = null, facts = null, actions = null, onClose, inline = false }) {
  const t = useT();
  const isPhone = useIsMobile();
  const asInline = inline === 'desktop' ? !isPhone : !!inline;
  ...
  if (asInline) return <section className="place-sheet ps-inline" aria-label={p.name}>{content}</section>;
  return (
