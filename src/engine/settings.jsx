...
const ES = {
  ...
  'min ago': 'min',
  // Connect your AI (MCP connector) + the OAuth consent page
  'Connect your AI': 'Conecta tu IA',
  'Plan with the AI you already use and save the ride here.': 'Planifica con la IA que ya usas y guarda la ruta aquí.',
  'AI connector': 'Conector de IA',
  'Add it as a custom connector or MCP server. Hosts that can sign in will send you back here to approve the connection with your Roadbook account.': 'Añádelo como conector personalizado o servidor MCP. Las apps que pueden iniciar sesión te traerán aquí para aprobar la conexión con tu cuenta de Roadbook.',
  'An AI app': 'Una app de IA',
  'Approve': 'Aprobar',
  'Ask the AI you already use — Claude, ChatGPT, Claude Code — where to ride, see every road measured with traffic and tolls, and save the one you pick straight into this library.': 'Pregunta a la IA que ya usas — Claude, ChatGPT, Claude Code — adónde ir, mira cada carretera medida con tráfico y peajes, y guarda la que elijas directamente en esta biblioteca.',
  'Checking who is asking…': 'Comprobando quién lo pide…',
  'Connect to your Roadbook': 'Conectar con tu Roadbook',
  'Connector address': 'Dirección del conector',
  'Connector tokens': 'Tokens de conector',
  'Copied': 'Copiado',
  'Copy': 'Copiar',
  'Create and edit trips in your library': 'Crear y editar viajes en tu biblioteca',
  'Deny': 'Denegar',
  'Done — you can close this window.': 'Listo — puedes cerrar esta ventana.',
  'For a host that only takes a key — the stdio bridge, a script. A token is shown once; revoke it here any time.': 'Para una app que solo acepta una clave — el puente stdio, un script. El token se muestra una sola vez; revócalo aquí cuando quieras.',
  'Label (e.g. Claude Desktop)': 'Etiqueta (p. ej. Claude Desktop)',
  'Make a token': 'Crear un token',
  'Measure roads, traffic and tolls on your behalf': 'Medir carreteras, tráfico y peajes por ti',
  'Read your trips, places and riding profile': 'Leer tus viajes, lugares y perfil de conducción',
  'Requested': 'Solicitado',
  'Revoke': 'Revocar',
  'Sign in to make a connector token.': 'Inicia sesión para crear un token de conector.',
  'Sign in to your Roadbook account to approve this connection.': 'Inicia sesión en tu cuenta de Roadbook para aprobar esta conexión.',
  'This connection request is not valid any more.': 'Esta solicitud de conexión ya no es válida.',
  'This link is missing its authorization id. Start the connection again from your AI app.': 'A este enlace le falta el id de autorización. Inicia la conexión de nuevo desde tu app de IA.',
  'You can revoke this later from your account. Nothing is shared with anyone else.': 'Puedes revocarlo más tarde desde tu cuenta. No se comparte nada con nadie más.',
  'Your new token — copy it now, it will not be shown again.': 'Tu nuevo token — cópialo ahora, no se volverá a mostrar.',
  ...
  'Favorites': 'Favoritos',
  'Link': 'Enlace',
  'Link copied — paste it into a message.': 'Enlace copiado: pégalo en un mensaje.',
  'Making a link…': 'Creando el enlace…',
  'New list': 'Nueva lista',
  'Nothing in this list yet. Open a place — tap it on the map, or press and hold to drop a pin — and Save it here.': 'Esta lista aún está vacía. Abre un lugar —tócalo en el mapa o mantén pulsado para soltar un pin— y guárdalo aquí.',
  ...
  'Save places you ride to — tap one on the map, or press and hold to drop a pin, then Save. Share a place or a whole list as a link.': 'Guarda los lugares a los que vas: toca uno en el mapa o mantén pulsado para soltar un pin y luego Guardar. Comparte un lugar o una lista entera con un enlace.',
  'Save them to my places': 'Guardarlos en mis lugares',
  'Save to': 'Guardar en',
  'Saved': 'Guardados',
  'Saved place': 'Lugar guardado',
  ...
  'Sure? Delete list': '¿Seguro? Eliminar lista',
  'The places ride inside this link, so it is long — it still opens anywhere.': 'Los lugares van dentro del enlace, por eso es largo; aun así se abre en cualquier sitio.',
  'Use it as': 'Usarlo como',
  'Whoever opens the link sees it on their map in Roadbook and can save it to their own places.': 'Quien abra el enlace lo verá en su mapa de Roadbook y podrá guardarlo en sus lugares.',
  'e.g. Moto shops': 'p. ej. Talleres de motos',
  'e.g. cheapest gas on the corridor, covered parking': 'p. ej. la gasolina más barata del tramo, estacionamiento techado',
  'in Roadbook': 'en Roadbook',
  'more': 'más',
  'optional — the planner reads these when you say “from home”': 'opcional: el planificador los usa cuando dices «desde casa»',
  'place': 'lugar',
  'places': 'lugares',
  'whoever opens the link sees them on their map in Roadbook and can save them to their own places.': 'quien abra el enlace los verá en su mapa de Roadbook y podrá guardarlos en sus lugares.',
};
